...
namespace type_coord
{
    public partial class Form1 : Form
    {
        ...
        {
            int x, y;
            List<TextBox> txtListP = new List<TextBox>
                { txtX1, txtX2, txtX3, txtX4, txtY1, txtY2, txtY3, txtY4 };

            pPoints = new List<Point>();
            for (int i = 0; i < 4; i++)
            {
                x = Convert.ToInt32(txtListP[i].Text);
                y = Convert.ToInt32(txtListP[i+4].Text);
